...
if (ValidateLunes(lineData1, lineData2))
{
...
double[] InputLineData(int numberOfLine)
{
    ...
    lineData[CONSTANT]=Prompt($"Введите коэфициент для {numberOfLine} прямой >");
    return lineData;
}
...
bool ValidateLunes(double[] lineData1, double[] lineData2)
{
